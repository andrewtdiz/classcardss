<template>
  <div v-click-outside="handleOffClick" @click="handleClick" @mouseenter="hovering = true" @mouseleave="hovering = false" class="flex items-center ml-3 h-10 cursor-pointer">
        ...
        <div @click.stop="" :class="display==name ? ['opacity-100', ' mt-16'] : ['opacity-0', 'pointer-events-none', 'mt-12']" class="absolute border border-gray-400 mr-6 transition-margin top-0 right-0 py-1 bg-white rounded-md  flex flex-col shadow-xl">
